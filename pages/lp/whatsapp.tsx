...
const coaches = (props: Props) => {
  return (
    <LandingPageLayout>
      ...
      <WhatWeDo 
        data={whatwedo} 
        title="Low Conversion and Poor Lead Quality?" 
      />
      <Features contents={features}>
        <SolutionSectionHeading className="text-center mb-10" >
        Nurture Every Lead to Convert  <br className="hidden lg:inline-block bg-red-100"/>More with Zigment
          <Image
            src={line}
            alt=""
            className="w-[200px] absolute inset-x-0 mx-auto  lg:translate-x-full   -bottom-4"
          />
