          ...
          <div className="flex-1 ">
            ...
            <div className="row">
              <div className="col">
                ...
                <h2>AI & Data Policy</h2>
                <p>
                  We use AI models from Google, Microsoft, OpenAI, Meta and other third-party vendors.
                  You agree to allow us to use your data to train our AI models.
                  As a part of our services, we use AI models to provide better user experience.
                  As you use our services, you agree to allow us to use your data to train our AI models & share with other vendors.
                </p>
              </div>
            </div>
          </div>
